  ...
  return (
    <div> 
      <Header/>
      {
        ...
        <>
        <Cards showIncomeModal={showIncomeModal}  showExpenseModal={ showExpenseModal} income={income} expense={expense} totalBalance={totalBalance}/>
             {transactions.length != 0 ? <ChartComponent sortedTransactions={sortedTransactions}/>: <NoTransactions/>}
          <ExpenseModal isExpenseModalVisible={isExpenseModalVisible} hideExpenseModal={hideExpenseModal} onFinish={onFinish}/>
          <IncomeModal isIncomeModalVisible={isIncomeModalVisible} hideIncomeModal={hideIncomeModal} onFinish={onFinish}/>
          <TransactionsTable transactions={transactions} addTransaction={addTransactions} fetchTransactions = {fetchTransactions}/>
        </>)
      }
    </div>
  )
